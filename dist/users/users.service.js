...
const createUser = (userBody) => __awaiter(void 0, void 0, void 0, function* () {
    if (yield users_model_1.User.isEmailTaken(userBody.email)) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Email already taken');
    }
    return users_model_1.User.create(userBody);
});
/**
 * Query for users
...
const queryUsers = (filter, options) => __awaiter(void 0, void 0, void 0, function* () {
    const users = yield users_model_1.User.paginate(filter, options);
    return users;
});
/**
 * Get user by id
...
const getUserByEmail = (email) => __awaiter(void 0, void 0, void 0, function* () {
    return users_model_1.User.findOne({ email });
});
/**
 * Update user by id
...
const updateUserById = (userId, updateBody) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (updateBody.email && (yield users_model_1.User.isEmailTaken(updateBody.email, userId))) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Email already taken');
    }
